...
//display msg
if($s==15){
  echo  '<center><h1>Congratulation full Score</h1><center><br/><hr/>';
} elseif ($s > "9") {
  echo  '<center><h1>very good you did well</h1><center><br/><hr/>';
  //PHP
  if($eid == "5b07969585502" ){
    echo'<button align="left" type="submit" <button class="btn btn-primary" onclick=location.href="phpa.php">View Answer</button> &nbsp;</button></form></div><br />';
  }
  //linux
  elseif($eid == "5b0784893c7c6" ){
    echo'<button align="left" type="submit" <button class="btn btn-primary" onclick=location.href="lina.php">View Answer</button> &nbsp;</button></form></div><br />';
  }
  //MultiM
  elseif($eid == "5b0798af060d5" ){
    echo'<button align="left" type="submit" <button class="btn btn-primary" onclick=location.href="multia.php">View Answer</button> &nbsp;</button></form></div><br />';
  }
  //C Porg
  elseif($eid == "5b079ce23a070" ){
    echo'<button align="left" type="submit" <button class="btn btn-primary" onclick=location.href="cproga.php">View Answer</button> &nbsp;</button></form></div><br />';
  }
  //5b079f2d24224=java
  else{
    echo'<button align="left" type="submit" <button class="btn btn-primary" onclick=location.href="javaa.php">View Answer</button> &nbsp;</button></form></div><br />';
  }

} else {
  echo  '<center><h1>Poor Score</h1><center><br />';
  //PHP
  if($eid == "5b07969585502" ){
    echo'<button align="left" type="submit" <button class="btn btn-primary" onclick=location.href="phpa.php">View Answer</button> &nbsp;</button></form></div><br />';
  }
...
echo '<tr style="color:#66CCFF"><td>Total Questions</td><td>'.$qa.'</td></tr>
   ...
   echo'<br /><button align="right" type="submit" <button class="btn btn-primary" onclick=location.href="account.php?q=1s">Attempt More Quizes</button> &nbsp;</button><hr/></form></div>';
  }
